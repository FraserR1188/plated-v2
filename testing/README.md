...
| PL-020 | Minor | Batches "Logged" alert says "today's log" when a past day was picked | In progress | 2026-09-20-internal | batchLogAlert names the picked day via dateKey. Awaiting device pass |
| PL-021 | Minor | Today header overflows at 360dp, off-today pages with the Bundles chip | In progress | 2026-09-20-internal | Three 36dp icons; "Return to today" moved into the eyebrow. 208dp left block vs 183.6dp worst case. Awaiting device pass |
