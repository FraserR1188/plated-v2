...
| PL-042 | Major | `apple` staple is CoFID's cooking apple, aliased "eating apple" | In progress | 2026-09-25-internal | Root cause: the review file's DISH? flag hid the plain row (apple and pear; 60/191 staples had a flagged loser, 2 wrongly). Scope agreed 2026-09-26: apple 14-362→14-319, pear 14-365→14-321, lime 14-132→14-131, avocado 14-039→14-386, cabbage 13-509→13-582, coconut-milk 14-820→14-889; drop `bramley apple`. No unitGrams (no citable UK source; bare counts never hit unit_grams). --only added at e56634a. Drift check 2026-09-26 08:30: section A = the 9 predicted apple columns to the digit, B/C/D empty (no drift, no hand edits, chicken not live, no matcher rows live). Seed change 2d46c10; importer run and post-run checks owed |
...
| PL-053 | Minor | `pepper` aliases both bell-pepper and black-pepper; staple lookup has no ORDER BY | Logged | 2026-09-26-internal | PREDICTED. Also `green pepper` sits on the red-pepper row (13-524) |
