...
--
-- supabase/migrations/verify/20260920140000_verify.sql
--
-- Separate file, following the convention the recent migrations use
-- (20260901100000 onward). V0 and V6's pre-apply baseline must be captured
-- BEFORE applying; V6 must be run IMPERSONATED or it proves nothing.
-- ============================================================================
