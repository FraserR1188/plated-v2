...
|---|---|---|---|---|---|---|
| 2026-09-26 | self (dev pass; found in the receipt-scanner investigation, and PL-042's review of the staple seed) | investigation against master @ `177ed0a`; row counts measured on the live DB | none | 6 | 6 | `testing/2026-09-26-internal.md` |
